...
class NumberInputDialog {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ✅ Code input (Enter triggers تأكيد)
                    if (!isSubmitted)
                      _buildTextField(
                        label: "الكود",
                        ...
                        onSubmitted: (_) async {
                          await confirm(); // ✅ trigger تأكيد on Enter
                        },
                      ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        if (!isSubmitted) const SizedBox(width: 20),
                        if (!isSubmitted)
                          ElevatedButton(
                            style: ElevatedButton.styleFrom(
                            ...
                            onPressed: confirm, // ✅ same logic as Enter
                            child: const Padding(
                              padding: EdgeInsets.symmetric(
                                  horizontal: 16, vertical: 8),
                              child: Text(
  ...
  static Future<void> _handleConfirm(
    ...
    final product = items.firstWhere(
      (e) => e['productCodeBar'] == controller.text,
      orElse: () => {},
    );
